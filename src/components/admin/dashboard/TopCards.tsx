  ...
  const TopCardInfo = [
    {
      ...
      title: "Notes",
      desc: "4+",
      img: "/admin/images/svgs/icon-connect.svg",
    ...
    },
    {
      ...
      title: "Icons",
      desc: "+1K",
      img: "/admin/images/svgs/icon-speech-bubble.svg",
    ...
    },
    {
      ...
      title: "Blogs",
      desc: "10+",
      img: "/admin/images/svgs/icon-favorites.svg",
    ...
    },
    {
      ...
      title: "Tickets",
      desc: "8+",
      img: "/admin/images/svgs/icon-mailbox.svg",
    ...
    },
    {
      ...
      title: "Products",
      desc: "$96k",
      img: "/admin/images/svgs/icon-briefcase.svg",
    ...
    },
    {
      ...
      title: "Employees",
      desc: "96",
      img: "/admin/images/svgs/icon-user-male.svg",
