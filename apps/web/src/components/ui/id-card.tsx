...
import { useControlledIconAnimate } from "@/hooks/use-controlled-icon-animate";
...
const IdCardIcon = forwardRef<IdCardIconHandle, IdCardIconProps>(
  (
    ...
    useControlledIconAnimate(animate, controls);
    ...
    const handleMouseEnter = useCallback(
      (e: React.MouseEvent<HTMLDivElement>) => {
        if (isControlledRef.current || animate !== undefined) {
          onMouseEnter?.(e);
        } else {
