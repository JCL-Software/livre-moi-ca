...
const CARDS: {
  ...
  },
  {
    ...
    description:
      "La réservation se fait dans l’application. Le paiement en ligne passe par la plateforme — pas d’échange d’argent comptant.",
    icon: Lock,
  },
  {
    ...
    <section className="section-muted py-16 md:py-20">
      <div className="mx-auto max-w-6xl px-4">
        <SectionHeader
          ...
          subtitle={
            <>
              La confiance commence avant le départ. Chaque conducteur qui propose
              un trajet doit compléter les étapes de vérification requises avant de
              pouvoir accueillir des passagers.
              <br />
              Des informations claires pour choisir en toute confiance.
            </>
          }
        />
